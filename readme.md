# HTML  CSS Final project / Proyecto Final CSS HTML

## Summary / Descripcion
_This project is a Basic UI in the style of __WhatsApp Web__ (example) the design includes a sidebar, allows the user to find an specific chat and skip between chats. This is a very basic UI experience using only HTML/CSS for it_

_Este proyecto es una UI Basica copiando el estilo de __Whatsapp Web__ (ejemplo) el diseño incluye una barra lateral, le permite al usuario seleccionar un chat especifico e ir seleccionando distintos chats. esta es una UI muy basica solamente usando HTML/CSS para la maquetacion de la misma_
